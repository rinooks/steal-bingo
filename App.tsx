    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4 relative">
        ...
        <div className="max-w-xl w-full bg-white border-4 border-black p-8 shadow-neo relative">
          ...
          <p className="text-gray-600 text-center mb-8 font-mono text-sm font-bold">CORPORATE EDUCATION SOLUTION</p>
      ...
      <header className="w-full max-w-[1600px] p-4 flex justify-between items-center z-10">
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
             ...
             <button onClick={() => window.location.reload()} className="text-gray-400 hover:text-black transition-colors">
               <RefreshIcon />
             </button>
          </div>
        </div>
